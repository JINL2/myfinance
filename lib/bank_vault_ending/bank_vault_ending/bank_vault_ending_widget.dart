                                    ...
                                    if (_model.oPLCashLocation
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          if (_model.yesterdayCheck == false)
                                            FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                Builder(
                                                  builder: (context) {
                                                    ...
                                                    return ListView.separated(
                                                      ...
                                                      scrollDirection:
                                                          Axis.vertical,
                                                      itemCount: companyCurrency
                                                          .length,
                                                      separatorBuilder: (_,
                                                              __) =>
                                                          SizedBox(height: 8.0),
                                                      itemBuilder: (context,
                                                          companyCurrencyIndex) {
                                                        final companyCurrencyItem =
                                                            companyCurrency[
                                                                companyCurrencyIndex];
                                                        return Padding(
                                                          padding:
                                                                ...
                                                                child: Text(
                                                                  valueOrDefault<
                                                                    ...
                                                                    _model
                                                                        ...
                                                                        ?.where((e) =>
                                                                            e.currencyId ==
                                                                            companyCurrencyItem.currencyId)
                                                                        .toList()
                                                                        .firstOrNull
                                                                        ?.currencyName,
                                                                    'error',
