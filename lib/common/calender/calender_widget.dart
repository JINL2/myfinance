        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                wrapWithModel(
                  model: _model.calenderDayTextModel1,
                  updateCallback: () => safeSetState(() {}),
                  child: CalenderDayTextWidget(
                    day: 'Mon',
                  ),
                ),
                wrapWithModel(
                  model: _model.calenderDayTextModel2,
                  updateCallback: () => safeSetState(() {}),
                  child: CalenderDayTextWidget(
                    day: 'Tue',
                  ),
                ...
                wrapWithModel(
                  model: _model.calenderDayTextModel3,
                  updateCallback: () => safeSetState(() {}),
                  child: CalenderDayTextWidget(
                    day: 'Wed',
                  ),
                ...
                wrapWithModel(
                  model: _model.calenderDayTextModel4,
                  updateCallback: () => safeSetState(() {}),
                  child: CalenderDayTextWidget(
                    day: 'Thu',
                  ),
                ...
                wrapWithModel(
                  model: _model.calenderDayTextModel5,
                  updateCallback: () => safeSetState(() {}),
                  child: CalenderDayTextWidget(
                    day: 'Fri',
                  ),
                ...
                wrapWithModel(
                  model: _model.calenderDayTextModel6,
                  updateCallback: () => safeSetState(() {}),
                  child: CalenderDayTextWidget(
                    day: 'Sat',
                  ),
                ...
                wrapWithModel(
                  model: _model.calenderDayTextModel7,
                  updateCallback: () => safeSetState(() {}),
                  child: CalenderDayTextWidget(
                    day: 'Sun',
                  ),
