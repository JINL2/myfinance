                  ...
                  builder: (context, snapshot) {
                    ...
                    return FlutterFlowDropDown<String>(
                      ...
                      onChanged: (val) async {
                        ...
                        _model.chooseUserName = userIdDropdownVUserStoresRowList
                            .where(
                                (e) => _model.userIdDropdownValue == e.userId)
                            .toList()
                            .firstOrNull
                            ?.userFullname;
                        safeSetState(() {});
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      if (functions.managerShiftIsHaveData(
                          ...
                          functions.changeDateTimeToString(_model.selectedDate),
                          _model.shiftDropDownValue,
                          _model.userIdDropdownValue,
                          _model.storeDropdownValue)) {
                        await showDialog(
                        ...
                        _model.newManageShiftData =
                          ...
                          FFAppState()
                              .shiftMetaData
                              .where(
                                  (e) => _model.shiftDropDownValue == e.shiftId)
                              .toList()
                              .firstOrNull
                              ?.shiftName,
                        );
