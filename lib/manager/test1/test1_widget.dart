      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Builder(
              builder: (context) {
                final dream1 = (widget.filteredStore != null &&
                            widget.filteredStore != ''
                        ? FFAppState()
                            .managerShiftDetail
                            .where((e) => widget.filteredStore == e.storeId)
                            .toList()
                            .sortedList(
                ...
                return ListView.builder(
                  ...
                  itemCount: dream1.length,
                  itemBuilder: (context, dream1Index) {
                    final dream1Item = dream1[dream1Index];
                    return Padding(
                      padding:
